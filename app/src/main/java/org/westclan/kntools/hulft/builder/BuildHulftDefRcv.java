...
/**
 * クラス：Hulftの集信管理情報 組み立て ArrayList<String>
 */
public class BuildHulftDefRcv extends ABuildHulftDef {

    /**
     * Hulftの集信管理情報 組み立て ArrayList<String>
     * 
     * @param stringDefine
     * @return
     * @throws IOException
     */
    public ArrayList<String> buildHulftDefRcv(String stringDefine) throws IOException {
